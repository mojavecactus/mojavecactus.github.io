...
var ASSETS = ['./', './index.html', './app-4.146.js', './ccscan.js', './payload.enc.json', './cc.enc.json', './cc-buf.enc.json', './cc-la.enc.json', './cc-syr.enc.json', './cc-ri.enc.json', './cc-wm.enc.json', './cc-sbx.enc.json', './fa2.enc.json', './fa2-fa.enc.json', './manifest.webmanifest', './img-manifest.json', './icon-180.png', './icon-512.png', './icon-512-maskable.png', './favicon.svg', './lib/inflate.js', './lib/zxing-reader.js', './lib/zxing_reader.wasm'];
// Core = everything the app needs to run and scan offline. These must land.
var CORE = ['./', './index.html', './app-4.146.js', './ccscan.js', './payload.enc.json', './cc.enc.json', './cc-buf.enc.json', './cc-la.enc.json', './cc-syr.enc.json', './cc-ri.enc.json', './cc-wm.enc.json', './cc-sbx.enc.json', './fa2.enc.json', './fa2-fa.enc.json', './manifest.webmanifest', './img-manifest.json', './lib/inflate.js', './lib/zxing-reader.js', './lib/zxing_reader.wasm'];
