...
const SEED = {
  ...
  tbx_cc_dev: "Nate's iPhone", tbx_cc_base: '[]', tbx_cc_hist: '{}', tbx_cc_locs: '["Trunk"]', tbx_fa2_draft: '{"form":{}}', tbx_fa2_trk: '[]',
  // cache / prefs
...
const MUST_STAY = ['tbx_cc', 'tbx_cc_ops', 'tbx_cc_dev', 'tbx_cc_base', 'tbx_cc_hist', 'tbx_cc_locs', 'tbx_buf_cc_ops', 'tbx_learn_q', 'tbx_uq', 'tbx_favs', 'tbx_recents',
  'tbx_learned', 'tbx_fa2_draft', 'tbx_fa2_trk', 'tbx_hubterrs', 'tbx_fsort', 'tbx_uid', 'tbx_tour_done'];
(async () => {
